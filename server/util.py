...
def classify_image(image_base64_data, file_path=None):
    ...
    print("Number of cropped faces:", len(imgs))
...
if __name__ == '__main__':
    ...
    # print(classify_image(None,"./server/artifacts/test_images/badminton_player.jpg"))
    # print(classify_image(None,"./server/artifacts/test_images/messi_1.jpg"))
    print(classify_image(None,"./server/artifacts/test_images/ronaldo_1.jpg"))